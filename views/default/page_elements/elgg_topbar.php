...
<div id="elgg_topbar_container_left">
	<div class="toolbarimages">
		...
		<a href="http://<?php echo $vars['entity']->name; ?>.<?php echo get_plugin_setting('domain', 'profile_friendlyurl'); ?>"><img class="user_mini_avatar" src="<?php echo $_SESSION['user']->getIcon('topbar'); ?>" /></a>
