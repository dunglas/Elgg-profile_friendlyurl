...
<div class="avatar_menu_button"><img src="<?php echo $vars['url']; ?>_graphics/spacer.gif" border="0" width="15px" height="15px" /></div>
	...
	<div class="sub_menu">
		<a href="http://<?php echo $vars['entity']->name; ?>.<?php echo get_plugin_setting('domain', 'profile_friendlyurl'); ?>"><h3><?php echo $vars['entity']->name; ?></h3></a>
		<?php
			if (isloggedin()) {
	...
	<?php
	 ...
	 ?><a href="http://<?php echo $vars['entity']->name; ?>.<?php echo get_plugin_setting('domain', 'profile_friendlyurl'); ?>" class="icon" ><?php 
		}
